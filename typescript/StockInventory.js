 ...
 */
var StockInventory = /** @class */ (function () {
    function StockInventory(shareName, numberOfShares, priceOfShares, totalPrice) {
     ...
     */
    StockInventory.prototype.addStock = function () {
        try {
            var no = readlineSync.question('Enter the number of stocks: '); //reading user input
            for (var i = 0; i < no; i++) {
                var shareName = readlineSync.question('Enter share name: '); //reading user input
                var numberOfShares = readlineSync.question('enter no of share'); //reading user input
                var priceOfShares = readlineSync.question('Enter price for shares: '); //reading user input
     ...
     * @param: data, data1
     */
    StockInventory.prototype.viewFile = function () {
...
exports.StockInventory = StockInventory;
