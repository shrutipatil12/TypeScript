...
var Stock = /** @class */ (function () {
     ...
     */
    Stock.prototype.readInput = function () {
        var data = filestream.readFileSync('/home/user/TypeScript/stock.json'); // reading json file
        var data1 = JSON.parse(data); //parsing data to convert json object into string
        return data1;
    };
    /**
     ...
     */
    Stock.prototype.calculateShares = function () {
        try {
            //let stock = new Stock
